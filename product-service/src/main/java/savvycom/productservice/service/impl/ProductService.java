...
public class ProductService implements IProductService {
    ...
    public Product create(Product product) {
        if(Objects.nonNull(product.getSize())) product.setSize(product.getSize());
        if(Objects.nonNull(product.getColor())) product.setColor(product.getColor());
        if(Objects.nonNull(product.getPrice())) product.setPrice(product.getPrice());
        if(Objects.nonNull(product.getProductLineId())) product.setProductLineId(product.getProductLineId());
        if(Objects.nonNull(product.getActive())) product.setActive(product.getActive());
